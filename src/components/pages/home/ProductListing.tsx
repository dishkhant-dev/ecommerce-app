    ...
    return (
        <div className={`${classname}`}>
                ...
                {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <h3 className="font-bold text-[20px] leading-[100%] text-[#000000]">T-shirt with tape details</h3>

                            <div className="flex items-center gap-[13px]">
                                <div className="flex items-center gap-[5.31px]">
                                    {[1, 2, 3, 4].map((i) => (
                                ...
                                <p className="text-[14px] leading-[100%] text-[#000000]">4.5/5</p>
                            </div>
                            {i === 1 ? (
                                <div className="flex items-center gap-2.5">
                                    <p className="text-[24px] font-bold leading-[100%] text-[#000000]">$120</p>
                                    <p className="text-[24px] font-bold leading-[100%] text-[#00000066] line-through">$260</p>
                                    <div className="bg-[#FF33331A] rounded-[62px] py-1.5 px-3 text-[#FF3333] text-[12px] font-medium leading-[100%]">-20%</div>
                                </div>
                            ) : (
                                <p className="text-[24px] font-bold leading-[100%] text-[#000000]">$120</p>
                            )}
            ...
            <div className="mt-9 flex items-center justify-center">
                <button className="cursor-pointer border border-[#0000001A] rounded-[62px] py-[15px] px-20 text-[#000000] font-medium text-[16px] leading-[100%]">View All</button>
            </div>
        </div>
    )
}
