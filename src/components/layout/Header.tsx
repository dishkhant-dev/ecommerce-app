    ...
    return (
        <div className="bg-[#000000] grid grid-cols-12 items-center padding-main-x py-[9px]">
            ...
            <div className="col-span-12 sm:col-span-10">
                <p className="text-center text-white text-[12px] sm:text-[13px] md:text-[14px] leading-[100%]">
            ...
            <div className="hidden col-span-1 sm:flex items-center justify-end">
                <svg
                    className="cursor-pointer w-[16px] h-[16px] sm:w-[16px] sm:h-[16px] md:w-[18px] md:h-[18px] lg:w-[20px] lg:h-[20px]"
                    viewBox="0 0 20 20"
                    fill="none"
