...
const CartPageClient = () => {
    return (
        <div className="border-t border-[#0000001A] margin-main-x pt-5.5 sm:pt-6 pb-[170px]">
            <div className="flex items-center gap-1.5 sm:gap-3">
                <div className="flex items-center gap-1">
                    <span className="text-[#00000099] text-[14px] sm:text-[16px] leading-[100%]">Home</span>
            ...
            <h2 className="mt-2 mb-5 sm:mt-6 sm:mb-6 integralcf-font font-bold text-[32px] sm:text-[40px] leading-[100%] text-[#000000]">YOUR CART</h2>

            <div className="grid grid-cols-12 gap-5">
                <div className="col-span-12 sm:col-span-7">
                    <div className="border border-[#0000001A] rounded-[20px] py-3.5 sm:py-5 px-3.5 sm:px-6 flex flex-col gap-6">
                        <div className="flex items-center gap-3.5 sm:gap-4">
                            <div className="shrink-0 relative w-[99px] h-[99px] sm:w-[124px] sm:h-[124px]">
                                <Image
                                    src={ProductImage}
                                    alt="Product Image"
                                    fill
                            ...
                            <div className="w-full">
                                <div>
                                    <div className="flex items-center justify-between">
                                        <p className="text-[#000000] font-bold text-[16px] sm:text-[20px] leading-[100%] mb-2">Gradient Graphic T-shirt</p>
                                        <div className="flex flex-col items-end gap-14">
                                            <svg className="cursor-pointer w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="flex flex-col gap-1.5 sm:gap-2 text-[12px] sm:text-[14px] text-[#00000099] leading-[100%]">
                                        <p><span className="text-[#000000]">Size:</span> Large</p>
                                        <p><span className="text-[#000000]">Color:</span> White</p>
                                    </div>
                                    <div className="flex items-end justify-between">
                                        <p className="text-[#000000] text-[20px] sm:text-[24px] font-bold leading-[100%] mt-[13px] sm:mt-[15px]">$145</p>
                                        <div className="bg-[#F0F0F0] rounded-[62px] py-3 px-5 flex items-center gap-5">
                                            <svg className="cursor-pointer w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-span-12 sm:col-span-5">
                    <div className="border border-[#0000001A] rounded-[20px] pt-5 pb-5 sm:pb-8 px-5 sm:px-6">
                        <h2 className="text-[#000000] font-bold text-[20px] sm:text-[24px] leading-[100%] mb-4 sm:mb-6">Order Summary</h2>

                        <div className="flex flex-col gap-5">
                            <div className="flex items-center justify-between">
                                <h4 className="text-[#00000099] text-[16px] sm:text-[20px] leading-[100%]">Subtotal</h4>
                                <p className="text-[#000000] text-[16px] sm:text-[20px] leading-[100%] font-bold">$565</p>
                            </div>
                            <div className="flex items-center justify-between">
                                <h4 className="text-[#00000099] text-[16px] sm:text-[20px] leading-[100%]">Discount (-20%)</h4>
                                <p className="text-[#FF3333] text-[16px] sm:text-[20px] leading-[100%] font-bold">-$113</p>
                            </div>
                            <div className="flex items-center justify-between">
                                <h4 className="text-[#00000099] text-[16px] sm:text-[20px] leading-[100%]">Delivery Fee</h4>
                                <p className="text-[#000000] text-[16px] sm:text-[20px] leading-[100%] font-bold">$15</p>
                            </div>
                            <div className="border-t border-[#0000001A]"></div>
                            <div className="flex items-center justify-between">
                                <h4 className="text-[#00000099] text-[16px] sm:text-[20px] leading-[100%]">Total</h4>
                                <p className="text-[#000000] text-[16px] sm:text-[20px] leading-[100%] font-bold">$467</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 my-4 sm:my-6">
                            <div className="w-full relative">
                                ...
                                <input
                                    ...
                                    className="bg-[#F0F0F0] rounded-[62px] py-3 pl-11.5 sm:pl-13 w-full text-[#000000] text-[16px] leading-[100%] focus:outline-none focus:border-none"
                                />
                            </div>
                            <button className="bg-[#000000] rounded-[62px] py-[13px] px-9.5 text-white font-medium text-[14px] sm:text-[16px] leading-[100%] cursor-pointer shrink-0">Apply</button>
                        </div>
